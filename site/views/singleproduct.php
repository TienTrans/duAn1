        ...
        <div class="col-lg-7 col-xl-7">
          <div class="product_slider_img">
            <div id="vertical">
              ...
              <div data-thumb="../content/hinh/'.$image_1.'">
                <img src="../content/hinh/'.$image_1.'" alt="">
              </div>
              <div data-thumb="../content/hinh/'.$image_2.'">
                <img src="../content/hinh/'.$image_2.'" alt="">
              </div>
              ';
              }
              ?>
              
              <!-- <div data-thumb="../content/frontend/img/product/product_1.png">
                <img src="../content/frontend/img/product/product_1.png" />
              </div>
              <div data-thumb="../content/frontend/img/product/product_1.png">
                <img src="../content/frontend/img/product/product_1.png" />
              </div>
