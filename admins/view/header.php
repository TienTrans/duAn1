...
<head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="../content/backend/css/main.css" />
    ...
    <script type="text/javascript" src="../content/backend/css/ckeditor.js"></script>
</head>
...
<body onload="time()" class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user">
            <img class="app-sidebar__user-avatar" src="../content/hinh/mikedao.jpg" width="50px" alt="User Image" />
            <div>
                <p class="app-sidebar__user-name"><b>admin FFF</b></p>
        ...
        <ul class="app-menu">
            <li>
                <a class="app-menu__item haha" href="phan-mem-ban-hang.html"><i
                        class="app-menu__icon bx bx-cart-alt"></i>
                    <span class="app-menu__label">POS Bán Hàng</span></a>
            </li>
            <li>
                <a class="app-menu__item " href="index.html"><i class="app-menu__icon bx bx-tachometer"></i><span
            ...
            <li>
                <a class="app-menu__item" href="?mod=product&act=list"><i
