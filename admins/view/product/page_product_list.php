                                            ...
                                            echo '<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button
                                                            ...
                                                            data-category-id='.$sp['id_DanhMuc'].'"
                                                        >
...
-->
        <div
            ...
            data-keyboard="false"
        >
            <form method="post" action="?mod=home" enctype="multipart/form-data"=>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="exampleSelect1">
                                    <option <?php if(isset($trang_thai) && $trang_thai === 'Hết hàng') { echo 'selected'; } ?>>Hết hàng</option>
                                    <option <?php if(isset($trang_thai) && $trang_thai === 'Còn hàng') { echo 'selected'; } ?>>Còn hàng</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
